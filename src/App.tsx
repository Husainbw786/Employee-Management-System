...
function App() {
  ...
  const handleJobSelect = async (job: JobDescription) => {
    ...
    try {
      const response = await fetch('https://web-production-4db85.up.railway.app/api/v1/match-resumes', {
        method: 'POST',
        headers: {
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        {!selectedJob && (
          <div className="mb-8">
            ...
            <p className="text-gray-600 mb-8">Select a job position to view matching candidates</p>
          </div>
        )}
